...
The `add` command allow user to add group to a person.
...
**Cons:** Need to add <group></group> in <person></person> in addressbook.xml in order to run, will not be able to create an empty group. +
