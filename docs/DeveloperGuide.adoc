...
The ability for the user to define their own custom fields is implemented to give the users more control over the data they are keeping about their contacts.
