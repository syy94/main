...
=== Locating persons by other fields: `find`
...
* `find n/Bet n/9999 e/helloTim@gmail.com` +
Returns any person having names containing `Bet`, a phone number containing `9999`,
or email address `helloTim@gmail.com`
